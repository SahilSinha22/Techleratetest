  ...
  return (
    ...
    <div className="bg-card   bg-[#18191f] text-card-foreground p-4 md:p-20 xl:px-40 xl:py-0 ">
                  <div className="flex justify-between pl-10 items-center mb-3  lg:mb-4">
                    ...
                    <span className="text-6xl top-14  right-4 sm:text-8xl md:text-8xl font-bold absolute sm:top-20 md:top-20 2xl:top-20 2xl:right-14 md:right-10 text-white Poppins ">01</span>
                    </div>
                  </div>
