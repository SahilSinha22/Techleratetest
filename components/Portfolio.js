    ...
    {getVisibleServices().map((Services, index) => (
      ...
      <div  className="flex justify-between pl-10 items-center mb-3  lg:mb-4">
        ...
        <div className='relative'>
          <span className="text-6xl top-14  right-4 sm:text-8xl md:text-8xl font-bold absolute sm:top-20 md:top-20 2xl:top-20 2xl:right-14 md:right-10 text-white Poppins ">{Services.page}</span>
        </div>
      </div>
