...
const Started = () => {
  return (
    ...
    <div className="bg-[#7b61ff]  text-primary-foreground  py-10 shadow-lg w-full text-center">
      ...
      <h2 className="text-2xl sm:text-5xl md:text-6xl xl:text-7xl font-bold mb-4">LET’S <span className="text-white">START YOUR</span></h2>
      <h2 className="text-2xl sm:text-5xl md:text-6xl xl:text-7xl font-bold mb-4"> DIGITAL <span className="text-white">BUSINESS</span></h2>
