        ...
        <div className='bg-[#000000]' >
            ...
            <div className=' m-auto p-4 md:px-10 xl:px-20   pt-20 lg:pt-40 pb-20 max-w-screen-2xl 2xl:max-w-screen-2xl 2xl:mx-auto text-white '>
                <div class="flex flex-col max-w-7xl text-center  justify-center place-content-center leading-relaxed ">
                    <h2 class="text-base md:text-3xl lg:text-4xl xl:text-5xl font-medium leading-loose text-center text-primary Poppin">Know our team who is putting day & night <br />  for yourwonderful digital experience</h2>
                    <p class="mt-4 text-[12px]  md:text-lg lg:text-xl xl:text-3xl text-muted-foreground text-center Poppind leading-relaxed font-semibold  m-auto">
            ...
            <div className='bg-[#7B61FF]'>
                <div className=' flex  xl:gap-10  max-w-7xl  justify-around m-auto'>
                    <div className="text-center items-center  flex flex-col lg:my-20 justify-center">
                    ...
                    <div className="text-center  flex flex-col justify-center my-20  lg:pt-0 2xl:pt-0 items-center">
                    ...
                    <div className="text-center px-4 md:px-10 lg:px-4 flex flex-col my-20 justify-center items-center">
