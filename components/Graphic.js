  ...
  return (
    <div className="bg-black text-foreground p-8  xl:px-20 flex flex-col md:flex-row items-center">
                  ...
                  <div className="md:w-1/2 flex flex-row md:flex-row gap-4">
                    <Image className="w-[400px] h-[600px] mt-20  object-cover" src={Grap1} alt="Person working on a laptop with design sketches" width={400} height={4}/>
                    <Image className="w-[400px] h-[600px] mb-20   object-cover" src={Grap2} alt="Person using a drawing tablet" width={400} height={4}/>
                  </div>
                </div>
