              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:gap-8">
                <div className="bg-card p-4 rounded-lg ">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="bg-gray-700 text-[#627af1] text-base    py-1 px-4 rounded-full">DESIGN</span>
                    <span className="text-[#9a9898] text-base">June 30, 2024</span>
                  </div>
                ...
                <div className="bg-card p-4 rounded-lg ">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="bg-gray-700 text-[#627af1] text-base   py-1 px-4 rounded-full">MARKETING</span>
                    <span className="text-[#9a9898] text-base">June 30, 2024</span>
                  </div>
                ...
                <div className="bg-card p-4 rounded-lg ">
                  ...
                  <div className="flex items-center space-x-2 mb-2">
                    <span className="bg-gray-700 text-[#627af1] text-base  py-1 px-4 rounded-full">MARKETING</span>
                    <span className="text-[#9a9898] text-base">June 29, 2024</span>
                  </div>
