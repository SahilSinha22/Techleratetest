...
const DumyForm = ({ onClose }) => {
    ...
    return (
        ...
        <div class="md:justify-center px-4 md:px-0 Glassy  md:pl-0 items-center flex m-auto   duration-1000 overflow-y-auto fixed inset-0 z-20 outline-none  focus:outline-none">
            ...
            <div class="  flex w-auto md:w-[600px] lg:w-[800px]  lg:top-10 xl:top-0 xl:w-auto my-6 mx-auto md:justify-center place-content-center xl:max-w-4xl 2xl:max-w-7xl">
