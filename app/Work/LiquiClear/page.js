      ...
      <div className=" ">
        <div className="flex  flex-col items-center justify-center  bg-background text-foreground mt-10 md:mt-40 p-4">
          <Image
            ...
            height={5}
          />
          <h2 className="text-3xl Domine md:text-4xl text-center mb-4">
        ...
        <div className="xl:mx-40 mx-4 md:mx-10 mb-20 w-auto h-auto  rounded-2xl bannerxx">
          <div className=" text-white mt-10 mb-2 mx-5 xl:mt-5 lg:mb-8   md:mx-auto flex flex-col items-center text-center">
            ...
            <button onClick={handleButtonClick} className="border-white border mt-4 mb-6 lg:mb-8 lg:mt-4 bannerxx hover:bg-gradient-to-r hover:from-red-400 hover:to-purple-600 rounded-full  inline-flex items-center md:text-base bg-amber-500  py-2 px-4 xl:px-8   text-white lg:mr-10 xl:mr-0">
              Let&apos;s Talk
            </button>
          </div>
        </div>
