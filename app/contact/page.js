    ...
    <div>
      <div className='w-full  navbar '>
                ...
                <section className="flex flex-col md:flex-row justify-between   rounded-3xl w-full  md:gap-4 lg:gap-6 xl:gap-8 2xl:gap-10  lg:pt-4  md:px-0 md:flex Poppinx">
                  ...
                  <ul className="py-1 text-xs  lg:text-base xl:text-lg Poppin grid grid-cols-3">
                    {services.map((service, index) => (
                      <li key={index} className={`flex items-center mr-2 dropslash    w-auto sm:w-[220px] md:w-full lg:w-[240px]  xl:max-w-7xl xl:w-[300px] hover:text-[#7b61ff] custom-filter `}>
                        <Image
                          src={service.logo}
        ...
        className={`absolute w-full  lg:left-4 m-auto  justify-center mt-10 h-auto md:h-auto bg-white  rounded-3xl z-50 opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 ${
         pathname ==="/Technology/reactnative" || pathname === "/Work/LiquiClear" ? 'text-[#000000]' : 'text-[#000000]'
        }`}
      >
        ...
        <div className="">
          ...
          <div className=" h-[1000px] relative 2xl:px-40  md:h-[550px] ">
            ...
            <div className='flex flex-col md:flex-row  -top-60 md:-top-16   absolute z-10 lg:-top-20 h-auto justify-self-start 2xl:-top-52  md:justify-between px-4 md:pl-20 md:pr-10 2xl:p-20 2xl:pr-40'>
              ...
              <div className="   " >
                <div className="lg:pt-16 pt-10 w-auto  rounded-3xl bg-white  ">
      ...
      <div className="bg-[#18191F]  justify-start pb-20 px-6 md:px-10 2xl:px-52   ">
        ...
        <div className="map-responsive">
          <iframe className="w-72  md:w-[600px] max-w-screen-xl  sm:w-[600px] lg:w-[850px] lg:max-w-6xl xl:w-[1100px] 2xl:max-w-[1800px] xl:max-w-screen-2xl" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7005.246309723172!2d77.361188!3d28.61108!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce5697f8ef789%3A0x89218b014db0771c!2sPlatina%20Heights!5e0!3m2!1sen!2sin!4v1724229359599!5m2!1sen!2sin" width="950" height="400" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
          </iframe>
        </div>
